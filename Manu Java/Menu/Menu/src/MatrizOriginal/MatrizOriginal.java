package MatrizOriginal;

import java.awt.Color;
import java.util.ArrayList;
import javax.swing.JLabel;

public class MatrizOriginal extends javax.swing.JFrame {
    int xMouse,yMouse;
    public MatrizOriginal() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MatrizOriginal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MatrizOriginal().setVisible(true);
            }
        });
    }
