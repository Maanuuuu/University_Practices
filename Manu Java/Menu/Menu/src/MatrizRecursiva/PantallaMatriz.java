...
public class PantallaMatriz extends javax.swing.JFrame {
    int xMouse,yMouse;
    public PantallaMatriz() {
        initComponents();
    ...
    private void initComponents() {
        ...
        MostrarPotencia.setEditable(false);
        MostrarPotencia.setBackground(new java.awt.Color(255, 255, 255));
        MostrarPotencia.setColumns(20);
        MostrarPotencia.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        MostrarPotencia.setForeground(new java.awt.Color(255, 255, 255));
        MostrarPotencia.setRows(5);
        MostrarPotencia.setAutoscrolls(false);
        MostrarPotencia.setBorder(null);
        MostrarPotencia.setCaretColor(new java.awt.Color(255, 255, 255));
    ...
    private void OperarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OperarMouseClicked
        ...
        try{
            ...
            if ((num>=3)&&(num<=10)){
                ...
                int i=0;int j=0;
                Main.LlenadoMatriz(matriz, i, j);
                int[] diagoprin = new int[matriz.length];
                int[] DiagonalSecundaria=new int[matriz.length];
                int x=0;int y=0;
                double sumatoria=0;
                int mayor=matriz[0][matriz.length-1];
                int menor=matriz[0][0];
                String secuencia= "";
                String secuenciafibonacci="";
                mayor=Main.DeterminarMayor(matriz, mayor,y);
                menor=Main.DeterminarMenor(matriz, menor, y);
                BigInteger exponente= BigInteger.valueOf(mayor);
                BigInteger base= BigInteger.valueOf(menor);
                int n=mayor;
                int a= 0;
                int b= 1;
                int[] mayormatriz=new int[1];
                mayormatriz[0]=matriz[0][0];
                int u=0;int k=0;
                //Ejecucion de funciones
                
                MostrarMatriz.setText(ImpresionMatriz(matriz));
                Main.DiagonalPrincipal(matriz,diagoprin,x);
                Main.ordenar(diagoprin, u, diagoprin.length-1);
                x=0;
                secuencia=Main.MostrarDiagoPrin(diagoprin,secuencia,x);
                DiagoPrin.setText(secuencia);
                
                sumatoria= Main.DiagonalSecundaria(matriz, DiagonalSecundaria, sumatoria, i);
                DiagoSec.setText(String.format("%10.4f",(sumatoria/num)));
                BigInteger potencia= Main.Potencia(base, exponente);
                i=0;j=0;
                Main.MayorMatriz(matriz, mayormatriz, i, j);
                MostrarPotencia.setText(potencia+"");
                secuenciafibonacci=Main.Fibonacci(mayormatriz[0], a,b , secuenciafibonacci);
                Fibonacci.setText(secuenciafibonacci);
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaMatriz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaMatriz().setVisible(true);
